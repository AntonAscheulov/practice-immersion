...
<!--            </div>-->
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="c_<?php echo $user['id'];?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $user['name'] . ' ' . $user['last_name'];?>">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="delete_handler.php?id=<?php echo $user['id']?>" class="dropdown-item" onclick="return confirm('Вы уверены?');">
